...
let is_of_length__when_actual_has_specified_length__then_passed =
  __FUNCTION__ >:: fun _ ->
    (* when *)
    let action () = assert_that "qwerty" @@ Is.String.of_length 6 in
    (* then *)
    assert_that action Is.raising_nothing
...
let is_of_length__when_actual_shorter__then_failed =
  __FUNCTION__ >:: fun _ ->
    ...
    (* when *)
    let action () = assert_that value @@ Is.String.of_length length in
    (* then *)
    let expected =
      Assertion_failed
        (Printf.sprintf
...
let not_is_of_length__when_actual_has_specified_length__then_failed =
  __FUNCTION__ >:: fun _ ->
    ...
    (* when *)
    let action () = assert_that value @@ Satisfies.not @@ Is.String.of_length length in
    (* then *)
    let expected =
...
let not_is_of_length__when_actual_shorter__then_passed =
  __FUNCTION__ >:: fun _ ->
    (* when *)
    let action () = assert_that "qwer" @@ Satisfies.not @@ Is.String.of_length 6 in
    (* then *)
    assert_that action Is.raising_nothing
...
let not_is_of_length__when_actual_longer__then_passed =
  __FUNCTION__ >:: fun _ ->
    (* when *)
    let action () = assert_that "qwertyuiop" @@ Satisfies.not @@ Is.String.of_length 6 in
    (* then *)
    assert_that action Is.raising_nothing
